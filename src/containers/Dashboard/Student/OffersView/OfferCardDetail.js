...
import {
  Get_Job,
  Cancel_Offer_Decion_By_Students,
  Offer_Decion_By_Students,
} from "../../../../Redux/actions"
import Loader from "../../../../components/UI/Loader"
const OfferCardDetail = (props) => {
  const { offerID, setisDetail } = props
  ...
  const handleCancelRequest = (id) => {
    dispatch(Cancel_Offer_Decion_By_Students(id, setisDetail))
  }
  ...
  const handleOfferAccepted = (id, decision) => {
    dispatch(Offer_Decion_By_Students(id, decision, setisDetail))
  }
      ...
      return (
        <>
          ...
          >
            ...
            <span
              onClick={() => handleCancelRequest(JOB._id)}
              className="offer-apply-btn ml-5"
            >
              Se desinteressers
            </span>
          </div>
          <div className="offer-detail">
            <div className="offer-detail-container">
              {JOB.score && JOB.score * 100 > 0 ? (
                <div className="student-offer-detail-percentage">
                  {JOB.score * 100}%
                </div>
              ) : (
                ""
          ...
          <div className="offer-detail">
            <div className="offer-detail-container">
              ...
              <div className="offer-detail-buttons-container">
                <Button
                  onClick={() => handleOfferAccepted(JOB._id, "requested")}
                  classes={{
                ...
                <Button
                  onClick={() => handleOfferRejected(JOB._id, "rejected")}
                  classes={{
